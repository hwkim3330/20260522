 ...
 *  httpFetch(url, opts) — fetch() using built-in http/https (Node 14+); defers
 *                         to global fetch when available (Node 18+)
 */
...
function timeoutSignal(ms) {
  ...
  // Fallback: AbortController is available since Node 15; on Node 14 this
  // path is never reached in practice because Ubuntu 20 ships Node 16 via
  // NodeSource, but guard anyway.
